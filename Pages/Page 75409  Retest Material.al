page 75409 "Retest Material"//T12113-ABA-N
{
    ...
    begin
        ...
        if not QCSetup_lRec."Allow Retest QC" then
            Error('Allow Retest QC must be true on Quality Control Setup. ');
