Page 75414 "Item Tracking For SalesOdr QC"
{
    PageType = List;
    ...
    layout
    {
        area(content)
        {
            repeater(Group)
            {
                ...
                field(Quantity; Abs(Rec.Quantity)) //in backend Quantity is neg. So Abs function is using for user. don't confuse 
                {
                    ApplicationArea = Basic;
                    Editable = false;
                }
