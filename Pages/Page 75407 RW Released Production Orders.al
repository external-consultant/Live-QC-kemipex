page 75407 "RW Released Production Orders"
{
    //T07638 - Create new page
    ApplicationArea = All;
    Caption = 'Rework Released Production Orders';
    CardPageID = "RW-Released Production Order";
    Editable = false;
    PageType = List;
    SourceTable = "Production Order";
    SourceTableView = WHERE(Status = CONST(Released), "Rework Order" = const(TRUE));
    UsageCategory = Lists;
    ...
    layout
    {
        area(content)
        {
            repeater(Control1)
            {
                ...
                field("Variant Code"; Rec."Variant Code")//T12706
                {
                    ApplicationArea = Manufacturing;
