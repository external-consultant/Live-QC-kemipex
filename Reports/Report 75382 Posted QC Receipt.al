Report 75382 "Posted QC Receipt"
{
    // --------------------------------------------------------------------------------------------
    ...
    // --------------------------------------------------------------------------------------------
    DefaultLayout = RDLC;
    RDLCLayout = './Layouts/Posted QC Receipt.rdlc';
    ...
    dataset
    {
        dataitem("Posted QC Rcpt. Header"; "Posted QC Rcpt. Header")
        {
            ...
            column(ReportForNavId_4560; 4560)
            {
            }
            ...
            column(Posted_QC_rcpt__Header__Approved_By_; "Approved By")
            {
            }
            ...
            column(Posted_QC_rcpt__Header__PR_No__; "Item Journal Template Name")
            {
            }
            ...
            dataitem("Posted QC Rcpt. Line"; "Posted QC Rcpt. Line")
            {
                ...
                column(ReportForNavId_3520; 3520)
                {
                }
                ...
                column(ActValue; ActValue)
                {
                }
                column(ActOption; ActOption)
                {
                }
    ...
    var
        ...
        Quality_Checking_ReceiptCaptionLbl: label 'Inspection Report';
        ...
        ParameterCaptionLbl: label 'Parameter';
        ...
        Actual_ResultCaptionLbl: label 'Actual Result';
